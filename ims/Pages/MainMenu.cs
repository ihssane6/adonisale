namespace ims.Pages
{
    public static class MainMenu
    {
        ...
        {
            public const string PageName = "Client";
        ...
        {
            public const string PageName = "vendeur";
            public const string RoleName = "Representant";
        ...
        {
            public const string PageName = "Article";
            public const string RoleName = "Article";
        ...
        {
            public const string PageName = "Demande chargement";
            public const string RoleName = "Demande chargement";
        ...
        {
            public const string PageName = "Preparation";
            public const string RoleName = "Reception";
        ...
        {
            public const string PageName = "Commandes";
            public const string RoleName = "Commandes";
        ...
        {
            public const string PageName = "Tournee";
            public const string RoleName = "Tournee";
        ...
        {
            public const string PageName = "Facture";
            public const string RoleName = "Facture";
        ...
        {
            public const string PageName = "Payment ";
        ...
        {
            public const string PageName = " famille client";
            public const string RoleName = "Type client";
        ...
        {
            public const string PageName = "Type Payment ";
        ...
        {
            public const string PageName = " famille Article";
            public const string RoleName = "Type Article";
        ...
        public static class SProduct
        {
            ...
            public const string Path = "/SProduct/Index";
            public const string ControllerName = "SProduct";
            public const string ActionName = "Index";
        }
        ...
        {
            public const string PageName = "Changer Role";
